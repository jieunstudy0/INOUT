...
public class AiInsightService {
    ...
    private String buildPrompt() {
        ...
        long completedCount           = orderRequestRepository.countByStatus(OrderStatus.APPROVED);
        long pendingCount             = orderRequestRepository.countByStatus(OrderStatus.ORDERED);
