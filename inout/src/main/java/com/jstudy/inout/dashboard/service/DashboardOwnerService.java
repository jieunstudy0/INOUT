...
public class DashboardOwnerService {
    ...
    public DashboardOwnerResponse getSummary(Long ownerUserId) {
        ...
        return DashboardOwnerResponse.builder()
                ...
                .pendingOrderCount(orderRequestRepository.countByStoreIdAndStatus(storeId, OrderStatus.ORDERED))
                ...
                .staffCount(userRepository.countByStore_IdAndStatusNot(storeId, UserStatus.RESIGNED))
                .lockedStaffCount(userRepository.countByStore_IdAndIsLockedTrueAndStatusNot(storeId, UserStatus.RESIGNED))
                .build();
    }
}
