...
export function approveOrder(orderId) {
  return unwrap(client.patch(`/admin/orders/${orderId}/approve`));
}

export function rejectOrder(orderId, body = {}) {
  return unwrap(client.patch(`/admin/orders/${orderId}/reject`, body));
}
